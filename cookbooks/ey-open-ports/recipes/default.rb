# we want to be sure that these following ports are open:
# 8080: for Juggernaut
# 6379: for Redis. Open this port, so we can use the chat from our development computer

# 'chat' is the name of the node !! If you change the name, you have to change it too
